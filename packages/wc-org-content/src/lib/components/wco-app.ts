    ...
    return html`
      <wco-app-bar>
        ...
        <nav slot="actionItems">
          <a href="/introduction" active$="[[_pathIs(route, '/introduction')]]">Introduction</a>
          <a href="/learn" active$="[[_pathIs(route, '/learn')]]">Learn</a>
          <a href="/catalog" active$="[[_pathIs(route, '/catalog')]]">Catalog</a>
          <a href="/community" active$="[[_pathIs(route, '/community')]]">Community</a>
        </nav>
        <main>
            ...
            <div class="cards">
              <a href="/" class="card-link">
                <wco-card id="learn-card">
                  <img slot="background" src="/assets/illustrations/Computer%20display_outline.svg">
                  <h3>Learn</h3>
                  Learn all about web components: what they are, how to build them, useful libraries, and more.
                </wco-card>
              </a>
              <a href="/" class="card-link">
