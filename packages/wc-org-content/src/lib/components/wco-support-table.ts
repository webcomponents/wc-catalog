      ...
      <div id="container">
        ...
        <div class="row">
          <a spec href="https://html.spec.whatwg.org/multipage/scripting.html#the-template-element" target="_blank" rel="noopener">
            <div label="HTML Templates"><svg viewBox="0 0 26 22"><use xlink:href="/sprite.octicons.svg#template"></use></svg></div>
          </a>
        ...
        <div class="row">
          <a spec href="https://html.spec.whatwg.org/multipage/custom-elements.html" target="_blank" rel="noopener">
          ...
          <a title="Stable" href="https://platform-status.mozilla.org/#custom-elements"></a>
          <a title="Stable" href="https://developer.microsoft.com/en-us/microsoft-edge/platform/status/customelements/">
          </a>
        </div>
        <div class="row">
          ...
          <a title="Stable" href="https://platform-status.mozilla.org/#shadow-dom"></a>
          <a title="Stable" href="https://developer.microsoft.com/en-us/microsoft-edge/platform/status/shadowdom/">
          </a>
        </div>
        <div class="row">
          <a spec href="https://html.spec.whatwg.org/multipage/webappapis.html#integration-with-the-javascript-module-system" target="_blank" rel="noopener">
            <div label="ES Modules"><svg viewBox="0 0 26 22"><use xlink:href="/sprite.octicons.svg#import"></use></svg></div>
          </a>
